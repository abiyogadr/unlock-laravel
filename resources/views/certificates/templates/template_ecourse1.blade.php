...
@section('certificate_content')
    ...
    <div class="relative z-10 w-full h-full px-[60px] py-[30px] flex flex-col text-center box-border font-['Roboto'] text-[#333]">
        ...
        <div class="mb-[5px] border-b-[2px] border-[#f0f0f0] pb-[10px] mt-20">
        ...
        <div class="grow flex flex-col justify-center">
            ...
            <div class="text-[16pt] font-[800] text-[#333] leading-[1.1] my-[5px] uppercase max-w-[75%] mx-auto break-words whitespace-normal" style="display:-webkit-box; -webkit-line-clamp:3; -webkit-box-orient:vertical; overflow:hidden;">
                {{ $main_title }}
            </div>
            ...
            <div class="text-[10pt] text-[#444] mt-[10px] bg-[#ff6407]/[0.05] px-[20px] py-[8px] rounded-[8px] inline-block mx-auto w-fit">
                Issued at: <strong>{{ $event_date }}</strong> <br>
                @if($date_extra)
